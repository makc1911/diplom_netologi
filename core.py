...
class VkTools:
    ...
    def get_profile_info(self, user_id):
        ...
        user_info = {
            ...
            'id': info.get('id'),
            'age': self._bdate_to_year(info.get('bdate')) if 'bdate' in info else None,
    ...
    def search_users(self, params, offset, status=None):
        try:
    ...
    def get_photos(self, id):
        ...
        sort_result = sorted(result, key=lambda x: x['likes'] + x['comments'], reverse=True)
